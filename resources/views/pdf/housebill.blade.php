...
<body>
    ...
    <table class="bdt">
        <tr>
            ...
            <td class="bdl bdb pl2" rowspan="6" width="44%">
        ...
        <tr>
            <td class="bdb height-200" colspan="3">
        ...
        <tr>
            <td class="bdb bdr">
                ...
                <p class="content_1">MANILA NORTH HARBOUR</p>
            </td>
            <td class="bdb bdr">&nbsp;</td>
            <td class="bdb">
    ...
    <table>
        <tr>
            <td>Particulars furnished by Shipper</td>
            <td>
                <p>Marks & Nos.</p>
                <p>FCL/FCL</p>
                <p>CONT/SEAL NO:</p>
